#Demandez à l'utilisateur de saisir son prénom, son nom, son âge et sa taille. Stockez ces informations dans une variable. Ensuite, utilisez la fonction `f""` pour les afficher sur une seule ligne
